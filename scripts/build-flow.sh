...
rm -rf AntDesign.js.flow Entypo.js.flow EvilIcons.js.flow Feather.js.flow \
    ...
    Foundation.js.flow Ionicons.js.flow LineAwesome.js.flow MaterialCommunityIcons.js.flow \
...
node bin/generate-flow AntDesign Entypo EvilIcons Feather FontAwesome \
    FontAwesome5 FontAwesome5Pro Fontisto Foundation Ionicons LineAwesome  \
