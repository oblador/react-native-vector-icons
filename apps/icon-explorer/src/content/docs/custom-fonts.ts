...
> [!TIP]
> Before contributing a new font package, please read our [Contributing Guidelines](https://github.com/oblador/react-native-vector-icons/blob/master/CONTRIBUTING.md) and follow the [development workflow](https://github.com/oblador/react-native-vector-icons/blob/master/CONTRIBUTING.md#development-workflow) described there.
...
1. **Follow commit conventions** described in [CONTRIBUTING.md](https://github.com/oblador/react-native-vector-icons/blob/master/CONTRIBUTING.md#commit-message-convention)
2. **Create a pull request** following the [PR guidelines](https://github.com/oblador/react-native-vector-icons/blob/master/CONTRIBUTING.md#sending-a-pull-request)
3. **Include documentation** updates if needed
4. **Ensure all tests pass** in CI

## Font Versioning

Font package versions are independent of upstream font versions. We track the mapping in each font's README.md file as described in [CONTRIBUTING.md](https://github.com/oblador/react-native-vector-icons/blob/master/CONTRIBUTING.md#font-versioning).
