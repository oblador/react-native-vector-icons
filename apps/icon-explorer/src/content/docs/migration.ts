...
export const description = 'Migration guide for React Native Vector Icons between major versions';
...
export const tabs = {
  '2. Verify Manual Steps': [
    { label: 'Expo', content: expoSteps },
    { label: 'React Native CLI', content: reactNativeCLISteps },
  ],
};
