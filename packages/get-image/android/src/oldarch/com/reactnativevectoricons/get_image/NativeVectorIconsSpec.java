...
public abstract class NativeVectorIconsSpec extends ReactContextBaseJavaModule implements TurboModule {
  ...
  @ReactMethod
  @DoNotStrip
  public abstract void getImageForFont(String glyph, ReadableMap options, Promise promise);

  @ReactMethod(isBlockingSynchronousMethod = true)
  @DoNotStrip
  public abstract WritableMap getImageForFontSync(String glyph, ReadableMap options);
}
