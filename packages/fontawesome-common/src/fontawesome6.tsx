...
export const createFAIconSet = (metadata: Record<IconTypes, string[]>) => {
  ...
  const Icons = {
    regular: createIconSet(regularGM, 'FontAwesome6-Regular', 'FontAwesome6_Regular.ttf', fontStyle('400')),
    solid: createIconSet(solidGM, 'FontAwesome6-Solid', 'FontAwesome6_Solid.ttf', fontStyle('900')),
    brand: createIconSet(brandGM, 'FontAwesome6Brands-Regular', 'FontAwesome6_Brands.ttf', fontStyle('400')),
  };
