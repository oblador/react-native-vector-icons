...
Pod::Spec.new do |s|
  ...
  s.script_phase = {
    ...
    :script => <<~SCRIPT
      ...
      LIST_FONTS="\"$NODE_BINDARY\" \"${PODS_TARGET_SRCROOT}/lib/commonjs/scripts/getFonts.js\" \"$PROJECT_ROOT\"/package.json"
      /bin/sh -c "$WITH_ENVIRONMENT \"$LIST_FONTS\"" > "$RESOURCES_TO_COPY"
