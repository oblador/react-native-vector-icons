...
|**`size`**|Icon size.|`20`|
|**`iconStyle`**|Styles applied to the icon only, good for setting margins or a different color (note: margins **MUST** be set via `iconStyle`; may cause crashes otherwise).|`{marginRight: 10}`|
