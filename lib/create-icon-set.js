...
function createIconSet(glyphMap : Object, fontFamily : string, fontFile : string) : Function {
  var Icon = React.createClass({
    ...
    setNativeProps: function(nativeProps) {
      invariant(this._root != null, "Ref must have been set before calling setNativeProps");
    ...
    render: function() {
      ...
      if(Platform.OS === 'android') {
        ...
        invariant(TypefaceTextView != null, "TypefaceTextView component must be available on Android");
